...
import InscripcionTutorLegal from "./pages/InscripcionIndividual/InscripcionTutorLegal";
import SubirComprobante from "./pages/Comprobante/SubirComprobante";
import AreaCompetencia from "./pages/InscripcionIndividual/AreasCompetencia";
import InscripcionTutorAcademico from "./pages/InscripcionIndividual/InscripcionTutorAcademico";
import FormaInscripcion from "./pages/InscripcionIndividual/FormaInscripcion";
import OrdenPago from "./pages/InscripcionIndividual/OrdenDePago";
