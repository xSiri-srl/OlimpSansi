...
export default function InscripcionTutorLegal({
  ...
  const validateAllFields = () => {
    ...
    validateInput(formData.legal?.apellidoPaterno, "apellidoPaterno", /^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]*$/);
    validateInput(formData.legal?.apellidoMaterno, "apellidoMaterno", /^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]*$/);
    validateInput(formData.legal?.nombres, "nombres", /^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]*$/);
    ...
    if (ci?.length >= 7) {
      ...
      try {
        ...
        if (response.data.found) {
          ...
          handleInputChange('legal', 'nombres', String(tutorLegal.nombre || ""));
          handleInputChange('legal', 'apellidoPaterno', String(tutorLegal.apellido_pa || ""));
          handleInputChange('legal', 'apellidoMaterno', String(tutorLegal.apellido_ma || ""));
          handleInputChange('legal', 'correo', String(tutorLegal.correo || ""));
          handleInputChange('legal', 'telefono', String(tutorLegal.numero_celular || ""));
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="absolute right-10 top-1/2 transform -translate-y-1/2">
                {isSearching && <span className="text-blue-500 text-sm">Buscando...</span>}
                {tutorLegalFound && <span className="text-green-500 text-sm">✓ Encontrado</span>}
              </div>
            </div>
            
            {tutorLegalFound && (
              <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
                Tutor legal encontrado en el sistema. Los datos han sido cargados automáticamente.
              </div>
            )}
