          ...
          {totalErrors > 0 && (
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4 flex items-start">
              ...
              <p className="text-yellow-700 text-sm">
                ...
                competidores con errores que deben corregirse antes de
                continuar. Las filas marcadas en rojo indican los registros con
                problemas.
              </p>
            </div>
          )}
            ...
            <div className="mb-6 border-b pb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {responsableInscripcion?.correo || ""}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Teléfono</p>
                  <p className="font-medium">
                    {responsableInscripcion?.numero_celular || ""}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="bg-gray-50 p-3 rounded-md">
                  ...
                  {(() => {
                    ...
                    estudiantes.forEach((est) => {
                      if (
                        est.areas_competencia &&
                        Array.isArray(est.areas_competencia)
                      ) {
                        est.areas_competencia.forEach((area) => {
                          if (area.nombre_area) {
                            areaCount[area.nombre_area] =
                              (areaCount[area.nombre_area] || 0) + 1;
                          }
                        });
                      }
                    });
