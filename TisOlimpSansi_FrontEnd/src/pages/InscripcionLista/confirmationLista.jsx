    ...
    <div className="text-center">
      <div className="text-center">
        ...
        <div className="mb-6 border-b pb-4">
          ...
          <div className={`mt-6 ${estudiantes.length > 25 ? "max-h-96 overflow-y-auto pr-2" : ""}`}>
            <h4 className="font-medium text-gray-700 mb-2">Lista de Competidores</h4>
                    ...
                    .flatMap((estudiante, estudianteIndex) => {
                      ...
                      if (
                        ...
                        return [
                          {
                            id: estudianteIndex,
                            nombre: `${estudiante.estudiante?.nombre || ""} ${estudiante.estudiante?.apellido_pa || ""} ${estudiante.estudiante?.apellido_ma || ""}`,
                            area: "N/A",
                            categoria: "N/A",
                      ...
                      return estudiante.areas_competencia.map((area, areaIndex) => ({
        ...
        <div className="flex justify-center mt-6 gap-4">
          ...
          <button
            ...
            className="bg-blue-600 text-white px-6 py-2 rounded-md transition duration-300 ease-in-out hover:bg-indigo-500 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? "Registrando..." : "Registrar preinscripcion"}
          </button>
        </div>
      </div>
