    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        <div className="flex items-center justify-center mb-4">
          ...
          <h3 className="text-xl font-semibold text-yellow-700">Demasiados errores</h3>
        </div>
        
        <div className="text-center mb-6">
          <p className="text-gray-700">
            Se han detectado más de 10 competidores con errores. Por favor, revise su archivo 
            Excel y asegúrese de que todos los campos obligatorios estén correctamente completados.
          </p>
        </div>
